...
class PINDatasetV1(PointNavDatasetV1):
    ...
    def from_json(self, json_str: str, scenes_dir: Optional[str] = None) -> None:
        ...
        for i, episode in enumerate(deserialized["episodes"]):
            ...
            # Keep the episode_id from the JSON instead of renumbering.
            # The original str(i) collides across incremental capture rounds, since each round
            # holds a different episode list but numbers all of them from 0.
